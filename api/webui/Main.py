...
st.set_page_config(
    ...
    menu_items={
    "Report a bug": "https://github.com/Theideabased/aeterna/issues",
    "About": "# Aeterna\nSimply provide a topic or keyword for a video, and it will "
        "automatically generate the video copy, video materials, video subtitles, "
        "and video background music before synthesizing a high-definition short "
    "video.\n\nhttps://github.com/Theideabased/aeterna",
    },
)
                ...
                with llm_helper:
                    tips = """
                            ...
                            - **Base Url**: 一般为 http://localhost:11434/v1
                                - 如果 `Aeterna` 和 `Ollama` **不在同一台机器上**，需要填写 `Ollama` 机器的IP地址
                                - 如果 `Aeterna` 是 `Docker` 部署，建议填写 `http://host.docker.internal:11434/v1`
